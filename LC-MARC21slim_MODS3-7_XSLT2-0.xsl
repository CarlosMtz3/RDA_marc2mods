<xsl:stylesheet xmlns="http://www.loc.gov/mods/v3"
	...
	<!-- 
		...
		Revision 2.23 - Added a xsl:when to deal with '#' and ' ' in $marcLeader19 and $controlField008-18 - ws 2014/12/19
	...
	<!-- 
		...
		Two prameters
		$marcDataField: datafield node to use for processing
		$codes: list of subfield codes, no spaces
	-->
	<xsl:function name="local:subfieldSelect">
		<xsl:param name="marcDataField" as="node()"/>
		<xsl:param name="codes"/>
		<!-- Selects and prints out datafield -->
		<xsl:variable name="str">
			<xsl:for-each select="$marcDataField/child::*[contains($codes,@code)]">
	...
	<xsl:function name="local:specialSubfieldSelect">
		...
		<xsl:variable name="subfieldStr">
			<xsl:for-each select="$marcDataField/subfield">
				<xsl:if test="contains($anyCodes, @code) 
					or (contains($beforeCodes,@code) and following-sibling::subfield[@code=$axis])      
					or (contains($afterCodes,@code) and preceding-sibling::subfield[@code=$axis])">
	...
	<xsl:template match="record">
		...
		<mods version="3.7">
			<!-- Adds appropriate namespaces and schema declaration if root is record -->
			<xsl:if test="/record">
			...
			<!-- Call name templates -->
			<xsl:apply-templates
				select="datafield[@tag='100'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'100')]"
				mode="name"/>
			<xsl:apply-templates
				select="datafield[@tag='110'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'110')]"
				mode="name"/>
			<xsl:apply-templates
				select="datafield[@tag='111'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'111')]"
				mode="name"/>
			<xsl:apply-templates
			...
			<xsl:apply-templates
				...
				mode="name"/>
			<xsl:apply-templates
				select="datafield[@tag='720'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'720')]"
				mode="name"/>

			<!-- Call typeOfResource -->
			<xsl:call-template name="typeOfResource">
				<xsl:with-param name="marcLeader" select="$marcLeader"/>
			...
			<xsl:call-template name="genre">
				<!-- marcLeader marcLeader6 marcLeader7 marcLeader19 controlField008 typeOf008 -->
			...
			<!-- 2.32 - @264/ind2 -->
			<xsl:apply-templates
				select="datafield[@tag='264'][@ind2 ='0' or @ind2 ='1' or @ind2 ='2' or @ind2 ='3'] 
				| datafield[@tag='880'][starts-with(subfield[@code='6'],'264')][@ind2 ='0' or @ind2 ='1' or @ind2 ='2' or @ind2 ='3']"
				mode="originInfo"/>
			<!-- Call language templates -->
			<xsl:apply-templates select="controlfield[@tag='008']" mode="lang"/>
			<xsl:apply-templates
				select="datafield[@tag='041'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'041')]"
				mode="lang"/>
		...
		-->
			<xsl:apply-templates
				select="datafield[@tag='245'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'245')]
				| datafield[@tag='362'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'362')]
				| datafield[starts-with(@tag,'5')] | datafield[@tag='880'][starts-with(subfield[@code='6'],'5')]"
				mode="note"/>
			...
			<xsl:apply-templates
				...
				| datafield[@tag='610'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'610')] 
				| datafield[@tag='611'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'611')]
				| datafield[@tag='630'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'630')]
				| datafield[@tag='648'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'648')]
				| datafield[@tag='650'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'650')]
				| datafield[@tag='651'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'651')]
				| datafield[@tag='653'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'653')]
				| datafield[@tag='656'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'656')]
				| datafield[@tag='662'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'662')]
				| datafield[@tag='752'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'752')]"
				mode="subject"/>
			...
			<!-- series -->
			<!-- 2.32 - @490$ind1 -->
			<xsl:apply-templates select="datafield[@tag='490'][@ind1='0' or @ind1=' '] | datafield[@tag='880'][@ind1='0' or @ind1=' '][starts-with(subfield[@code='6'],'490')]" mode="relatedItem"/>
			<!-- 2.32 - @440$ind1 -->
			<xsl:apply-templates select="datafield[@tag='440'][@ind1='0' or @ind1=' '] | datafield[@tag='880'][@ind1='0' or @ind1=' '][starts-with(subfield[@code='6'],'440')]" mode="relatedItem"/>
			<!-- isReferencedBy -->
			<!-- 2.32 - @510$ind1 -->
			<xsl:apply-templates select="datafield[@tag='510'][@ind1='0' or @ind1=' '] | datafield[@tag='880'][@ind1='0' or @ind1=' '][starts-with(subfield[@code='6'],'510')]" mode="relatedItem"/>
			<!-- original -->
			<!-- 2.32 - @534$ind1 -->
			<xsl:apply-templates select="datafield[@tag='534'][@ind1='0' or @ind1=' '] | datafield[@tag='880'][@ind1='0' or @ind1=' '][starts-with(subfield[@code='6'],'534')]" mode="relatedItem"/>
			<xsl:apply-templates select="datafield[@tag='700'][subfield[@code='t']] | datafield[@tag='880'][subfield[@code='t']][starts-with(subfield[@code='6'],'700')]"
				mode="relatedItem"/>
			<xsl:apply-templates select="datafield[@tag='710'][subfield[@code='t']] | datafield[@tag='880'][subfield[@code='t']][starts-with(subfield[@code='6'],'710')]"
				mode="relatedItem"/>
			<xsl:apply-templates select="datafield[@tag='711'][subfield[@code='t']] | datafield[@tag='880'][subfield[@code='t']][starts-with(subfield[@code='6'],'711')]"
				mode="relatedItem"/>
			<xsl:apply-templates select="datafield[@tag='730'][@ind2='2'] | datafield[@tag='880'][@ind2='2'][starts-with(subfield[@code='6'],'730')]" mode="relatedItem"/>
			<xsl:apply-templates select="datafield[@tag='740'][@ind2='2'] | datafield[@tag='880'][@ind2='2'][starts-with(subfield[@code='6'],'740')]" mode="relatedItem"/>
			<!--2.32 - @777,@787 -->
			<xsl:apply-templates select="datafield[@tag='760'] | datafield[@tag='762'] | datafield[@tag='765'] | 
				...
				mode="relatedItem"/>
			<xsl:apply-templates select="datafield[@tag='800'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'800')]" mode="relatedItem"/>
			<xsl:apply-templates select="datafield[@tag='810'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'810')]" mode="relatedItem"/>
			<xsl:apply-templates select="datafield[@tag='811'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'811')]" mode="relatedItem"/>
			<xsl:apply-templates select="datafield[@tag='830'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'830')]" mode="relatedItem"/>
			<xsl:apply-templates select="datafield[@tag='856'][@ind2='2'] | datafield[@tag='880'][@ind2='2'][starts-with(subfield[@code='6'],'856')]" mode="relatedItem"/>

			<!--  Call templates for identifiers -->
			<xsl:apply-templates
				select="datafield[@tag='020'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'020')]"
				mode="id"/>
			<xsl:apply-templates
				select="datafield[@tag='024'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'024')]"
				mode="id"/>
			<xsl:apply-templates
				select="datafield[@tag='022'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'0222')]"
				mode="id"/>
			<xsl:apply-templates
				select="datafield[@tag='010'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'010')]"
				mode="id"/>
			<xsl:apply-templates
				select="datafield[@tag='028'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'0282')]"
				mode="id"/>
			<xsl:apply-templates select="datafield[@tag='035']" mode="id"/>
			<xsl:apply-templates
				select="datafield[@tag='037'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'037')]"
				mode="id"/>
			<xsl:apply-templates
				select="datafield[@tag='856']/subfield[@code='u'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'8856')]/subfield[@code='u']"
				mode="id"/>
	...
	<xsl:template
		match="datafield[@tag='130'] | datafield[@tag='880'][@ind2!='2'][starts-with(subfield[@code='6'],'130')]
		| datafield[@tag='730'][@ind2!='2'] | datafield[@tag='880'][@ind2!='2'][starts-with(subfield[@code='6'],'730')]"
		mode="titleInfo">
		<titleInfo type="uniform">
			...
			<xsl:apply-templates select="subfield[@code='n'][1]" mode="titleInfo"/>
			<xsl:apply-templates select="subfield[@code='p'][1]" mode="titleInfo"/>
		</titleInfo>
	</xsl:template>

	<!-- 210 titleInfo type abbreviated-->
	<xsl:template
		match="datafield[@tag='210'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'210')]"
		mode="titleInfo">
		<titleInfo type="abbreviated">
			...
			<!-- subtitle -->
			<xsl:apply-templates select="subfield[@code='b']" mode="titleInfo"/>
		</titleInfo>
	</xsl:template>

	<!-- 242 titleInfo translated -->
	<xsl:template match="datafield[@tag='242']" mode="titleInfo">
		<titleInfo type="translated">
			<!-- Added subfield $y-->
	...
	<xsl:template
		match="datafield[@tag='245'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'245')]"
		mode="titleInfo">
		<titleInfo>
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
			...
			<xsl:apply-templates select="subfield[@code='b']" mode="titleInfo"/>
			<!-- Part number -->
			<xsl:apply-templates select="subfield[@code='n']" mode="titleInfo"/>
			<!-- Part name -->
			<xsl:apply-templates select="subfield[@code='p'][1]" mode="titleInfo"/>
		</titleInfo>
	</xsl:template>
	...
	<xsl:template
		match="datafield[@tag='246'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'246')]"
		mode="titleInfo">
		<titleInfo>
	...
	<!-- 240 nameTitleGroup-->
	<xsl:template
		match="datafield[@tag='240'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'240')]"
		mode="titleInfo">
		<titleInfo type="uniform">
	...
	<xsl:template
		match="datafield[@tag='740'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'740')]"
		mode="titleInfo">
	...
	<xsl:template match="subfield[@code='b']" mode="titleInfo">
		<subTitle>
	...
	<xsl:template match="subfield[@code='n']" mode="titleInfo">
	...
	<xsl:template match="subfield[@code='p']" mode="titleInfo">
	...
	<xsl:template
		match="datafield[@tag='100'][not(subfield[@code='t'])] | datafield[@tag='880'][starts-with(subfield[@code='6'],'100')][not(subfield[@code='t'])]
		| datafield[@tag='700'][not(subfield[@code='t'])] | datafield[@tag='880'][starts-with(subfield[@code='6'],'700')][not(subfield[@code='t'])]"
		mode="name">
		<name>
			<!-- name attributes -->
			<xsl:choose>
			...
			<!-- @100/@880-usage -->
			<xsl:if test="@tag='100' or .[@tag='880'][starts-with(subfield[@code='6'],'100')][not(subfield[@code='t'])] ">
			...
			<xsl:for-each select="subfield[@code='b'] | subfield[@code='c']">
			...
			<!-- affilitation -->
			<xsl:apply-templates select="subfield[@code='u']" mode="affiliation"/>
			<!-- role -->
			<xsl:apply-templates select="subfield[@code='e'] | subfield[@code='4']"
				mode="role"/>
			<!-- 2.31 -->
			<xsl:apply-templates select="subfield[@code='0'] " mode="identifier"/>
		</name>
	</xsl:template>

	<!-- 110 710 name-->
	<xsl:template
		match="datafield[@tag='110'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'110')]
		| datafield[@tag='710'][not(subfield[@code='t'])] | datafield[@tag='880'][starts-with(subfield[@code='6'],'710')][not(subfield[@code='t'])]"
		mode="name">
		<xsl:if test="subfield[@code!='t']">
			<name type="corporate">
				...
				<xsl:apply-templates select="subfield[@code='0'][. != '']" mode="xlink"/>
				<!-- namePart -->
				<xsl:for-each select="subfield[@code='a'] | subfield[@code='b']">
					<namePart>
						<!-- 2.38 -->
						<xsl:value-of select="."/>
					</namePart>
	...
	<!-- 111 711 name -->
	<xsl:template
		match="datafield[@tag='111'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'111')]
		| datafield[@tag='711'][not(subfield[@code='t'])] | datafield[@tag='880'][starts-with(subfield[@code='6'],'711')][not(subfield[@code='t'])]"
		mode="name">
		<xsl:if test="subfield[@code!='t']">
	...
	<!-- 720 name -->
	<xsl:template
		match="datafield[@tag='720'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'720')]"
		mode="name">
		<xsl:if test="subfield[@code!='t']">
			<name>
				<!-- Template checks for altRepGroup - 880 $6 -->
	...
	<xsl:template name="typeOfResource">
		...
		<xsl:param name="marcLeader"/>
		<xsl:param name="marcLeader6"/>
		<xsl:param name="marcLeader7"/>
		<!-- Build type of resource element based on marcLeader values -->
		<typeOfResource>
			...
			<!-- add controled resource type generated from marcLeader -->
			<xsl:choose>
				...
				<xsl:when test="$marcLeader6='o'">kit</xsl:when>
	...
	<xsl:template name="genre">
		...
		<xsl:apply-templates
			select="datafield[@tag='047'][@ind2='7' or @ind2=' '] | datafield[@tag='880'][starts-with(subfield[@code='6'],'047')]"
			mode="genre"/>
	...
	<xsl:template
		match="datafield[@tag='047'][@ind2='7' or @ind2=' '] | datafield[@tag='880'][starts-with(subfield[@code='6'],'047')]"
		mode="genre">
		<!-- 2.37  -->
		<genre>
			<!-- 2.26 -->
	...
	<!-- 2.12 ws: added new genre template for 336 field -->
	<xsl:template
		match="datafield[@tag='336'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'336')]"
		mode="genre">
		<!-- 2.37  -->
		<genre>
			<!--2.24 -->
	...
	<xsl:template
		match="datafield[@tag='655'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'655')]"
		mode="genre">
		<!-- 2.37  -->
		<genre>
			<!-- 2.25 --> 
			...
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
			<!-- 2.47 <xsl:apply-templates select="subfield[@code='0'][. != '']" mode="xlink"/>-->
	...
	<xsl:template name="originInfo">
		...
		<xsl:param name="controlField008"/>
		<xsl:param name="typeOf008"/>
		<xsl:variable name="marcDataField260c" select="local:stripPunctuation(datafield[@tag=260]/subfield[@code='c'])"/>
		<xsl:variable name="originInfoShared">
			...
			<xsl:variable name="dataField260c" select="local:stripPunctuation(datafield[@tag='260']/subfield[@code='c'])"/>
			...
			<xsl:if
				...
				<xsl:if
					test="$controlField008-7-10 and ($controlField008-7-10 != $marcDataField260c)">
			...
			<xsl:if
				...
				<xsl:if test="$controlField008-7-10 and ($controlField008-7-10 != $marcDataField260c)">
			...
			<!-- 2.32 - @260$issuance -->
			<xsl:if test="$marcLeader7='a' or $marcLeader7='c' or $marcLeader7='d' or $marcLeader7='m' or $marcLeader7='b' 
				...
				<issuance>
					<xsl:choose>
						...
						<xsl:when test="$marcLeader7='s'">serial</xsl:when>
					</xsl:choose>
				</issuance>
			</xsl:if>
			<xsl:if test="$typeOf008='SE'">
		...
		<xsl:choose>
			<xsl:when test="datafield[@tag='044' or @tag='260' or @tag='046' or @tag='033' or @tag='250' or @tag='310' or @tag='321'][subfield[@code='6']]">
				<xsl:for-each select="datafield[@tag='044' or @tag='260' or @tag='046' or @tag='033' or @tag='250' or @tag='310' or @tag='321'][subfield[@code='6']]">
					<originInfo>
						<xsl:choose>
							<xsl:when test="self::subfield"><xsl:call-template name="xxs880"/></xsl:when>
							<xsl:when test="self::datafield"><xsl:call-template name="xxx880"/></xsl:when>
						</xsl:choose>
				...
				<xsl:if
					...
					<originInfo>
						<xsl:copy-of select="$originInfoShared"/>
						<xsl:for-each select="datafield[@tag='044' or @tag='260' or @tag='046' or @tag='033' or @tag='250' or @tag='310' or @tag='321'][not(subfield[@code='6'])]">
							<xsl:choose>
								<xsl:when test="@tag='260'">
									<xsl:apply-templates select="." mode="originInfo">
										<xsl:with-param name="marcLeader6" select="$marcLeader6"/>
			...
			<xsl:otherwise>
				<xsl:if
					...
					<originInfo>
						<xsl:copy-of select="$originInfoShared"/>
						<xsl:apply-templates select="datafield[@tag='044']" mode="originInfo"/>
						...
						<xsl:apply-templates select="datafield[@tag='310']|datafield[@tag='321']"
							mode="originInfo"/>
					</originInfo>
				</xsl:if>
			</xsl:otherwise>
		...
		<xsl:for-each
			select="datafield[@tag='880'][starts-with(subfield[@code='6'],'260')] 
	...
	<xsl:template match="datafield[@tag='264'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'264')]" mode="originInfo">
		<xsl:if test="@ind2 ='0' or @ind2 ='1'or @ind2 ='2' or @ind2 ='3'">
			<originInfo>
				...
				<!-- 2.50 -->
				<xsl:choose>
					<xsl:when test="count(subfield[@code='a']) gt 1">
						<xsl:for-each select="subfield[@code='a']">
							<place>
								<placeTerm type="text">
									<xsl:value-of select="."/>
	...
	<xsl:template name="altRepGrouporiginInfo">
		<xsl:variable name="x260">
			<xsl:for-each
				select="datafield[@tag='880'][starts-with(subfield[@code='6'],'260')]/subfield[@code='6']">
		...
		<xsl:variable name="x250">
			<xsl:for-each
				select="datafield[@tag='880'][starts-with(subfield[@code='6'],'250')]/subfield[@code='6']">
		...
		<xsl:variable name="x044">
			<xsl:for-each
				select="datafield[@tag='880'][starts-with(subfield[@code='6'],'044')]/subfield[@code='6']">
		...
		<xsl:variable name="x046">
			<xsl:for-each
				select="datafield[@tag='880'][starts-with(subfield[@code='6'],'046')]/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x033">
			<xsl:for-each
				select="datafield[@tag='880'][starts-with(subfield[@code='6'],'033')]/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x310">
			<xsl:for-each
				select="datafield[@tag='880'][starts-with(subfield[@code='6'],'310')]/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x321">
			<xsl:for-each
				select="datafield[@tag='880'][starts-with(subfield[@code='6'],'321')]/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
	...
	<xsl:template name="z2xx880">
		<xsl:variable name="x260">
			<xsl:for-each select="datafield[@tag='260']/subfield[@code='6']">
				<xsl:variable name="sf06260" select="normalize-space(.)"/>
				<xsl:variable name="sf06260b" select="substring($sf06260, 5, 2)"/>
				<xsl:value-of select="$sf06260b"/>
			</xsl:for-each>
		...
		<xsl:variable name="x250">
			<xsl:for-each select="datafield[@tag='250']/subfield[@code='6']">
				<xsl:variable name="sf06250" select="normalize-space(.)"/>
				<xsl:variable name="sf06250b" select="substring($sf06250, 5, 2)"/>
				<xsl:value-of select="$sf06250b"/>
			</xsl:for-each>
		...
		<xsl:variable name="x044">
			<xsl:for-each select="datafield[@tag='044']/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x046">
			<xsl:for-each select="datafield[@tag='046']/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x033">
			<xsl:for-each select="datafield[@tag='033']/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x310">
			<xsl:for-each select="datafield[@tag='310']/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x321">
			<xsl:for-each select="datafield[@tag='321']/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
	...
	<xsl:template
		...
		<xsl:for-each select="subfield[@code='c']">
			<xsl:choose>
				<xsl:when test="$marcLeader6='d' or $marcLeader6='f' or $marcLeader6='p' or $marcLeader6='t'">
					<dateCreated>
						<xsl:value-of select="local:stripPunctuation(.)"/>
					</dateCreated>
				</xsl:when>
	...
	<xsl:template
		...
		mode="originInfo">
		<xsl:for-each select=".[@ind1='0' or @ind1='1']/subfield[@code='a']">
			<dateCaptured encoding="iso8601">
				<xsl:apply-templates/>
			</dateCaptured>
		</xsl:for-each>
		<xsl:for-each select=".[@ind1='2']/subfield[@code='a'][1]">
			<dateCaptured encoding="iso8601" point="start">
				<xsl:apply-templates/>
			</dateCaptured>
		</xsl:for-each>
		<xsl:for-each select=".[@ind1='2']/subfield[@code='a'][2]">
	...
	<xsl:template match="controlfield[@tag='008']" mode="lang">
	...
	<xsl:template
		match="datafield[@tag='041'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'041')]"
		mode="lang">
		<xsl:variable name="controlField008-35-37"
			select="normalize-space(translate(substring(../controlfield[@tag='008'],36,3),'|#',''))"/>
		<xsl:for-each
			select="subfield[@code='a' or @code='b' or @code='d' or @code='e' or @code='f' or @code='g' or @code='h' or @code='j']">
			<!-- Creates language string for processing -->
			<xsl:variable name="langStr" select="."/>
			<!-- 
					Splits multiple language strings coded in a single subfield 
	...
	<xsl:template name="physicalDescription">
		...
		<xsl:variable name="physicalDescription">
			...
			<xsl:apply-templates
				select="datafield[@tag='130']/subfield[@code='h'] | datafield[@tag='240']/subfield[@code='h'] | 
				...
				mode="physDesc"/>
			<xsl:apply-templates select="datafield[@tag='856']/subfield[@code='q']" mode="physDesc"/>
			<xsl:apply-templates select="datafield[@tag='300']" mode="physDesc"/>
			<xsl:apply-templates select="datafield[@tag='351']" mode="physDesc"/>
		</xsl:variable>
		<xsl:choose>
			<xsl:when test="datafield[@tag='130'][subfield[@code='6']][child::*[@code='h']] or  
				...
				<xsl:for-each select="datafield[@tag='130'][subfield[@code='6']]/child::*[@code='h'] |  
				...
				<!-- Cover any physical -->
				<xsl:if test="datafield[@tag='130'][not(subfield[@code='6'])][child::*[@code='h']] or  
					...
					<physicalDescription>
						...
						<xsl:call-template name="reformattingQuality"/>
						<xsl:apply-templates select="datafield[@tag='130'][not(subfield[@code='6'])][child::*[@code='h']] |  
							...
							datafield[@tag='856'][not(subfield[@code='6'])][child::*[@code='q']]" mode="physDesc"/>
					</physicalDescription>
				</xsl:if>
			</xsl:when>
		...
		<xsl:for-each select="datafield[@tag='880'][starts-with(subfield[@code='6'],'130')]/child::*[@code='h'] | 
	...
	<xsl:template name="altRepGroupPhysDsc">
		<xsl:variable name="x130">
			<xsl:for-each
				select="datafield[@tag='880'][starts-with(subfield[@code='6'],'130')][child::*[@code='h']]/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x240">
			<xsl:for-each
				select="datafield[@tag='880'][starts-with(subfield[@code='6'],'240')][child::*[@code='h']]/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x242">
			<xsl:for-each
				select="datafield[@tag='880'][starts-with(subfield[@code='6'],'242')][child::*[@code='h']]/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x245">
			<xsl:for-each
				select="datafield[@tag='880'][starts-with(subfield[@code='6'],'245')][child::*[@code='h']]/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x246">
			<xsl:for-each
				select="datafield[@tag='880'][starts-with(subfield[@code='6'],'246')][child::*[@code='h']]/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x730">
			<xsl:for-each
				select="datafield[@tag='880'][starts-with(subfield[@code='6'],'730')][child::*[@code='h']]/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x256">
			<xsl:for-each
				select="datafield[@tag='880'][starts-with(subfield[@code='6'],'256')][child::*[@code='a']]/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x300">
			<xsl:for-each
				select="datafield[@tag='880'][starts-with(subfield[@code='6'],'300')]/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x856">
			<xsl:for-each
				select="datafield[@tag='880'][starts-with(subfield[@code='6'],'856')][child::*[@code='q']]//subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
	...
	<xsl:template name="z3xx880">
		<xsl:variable name="x130">
			<xsl:for-each
				select="datafield[@tag='130'][subfield[@code='h']]/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x240">
			<xsl:for-each
				select="datafield[@tag='240'][subfield[@code='h']]/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x242">
			<xsl:for-each
				select="datafield[@tag='242'][subfield[@code='h']]/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x245">
			<xsl:for-each
				select="datafield[@tag='245'][subfield[@code='h']]/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x246">
			<xsl:for-each
				select="datafield[@tag='246'][subfield[@code='h']]/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x730">
			<xsl:for-each
				select="datafield[@tag='730']/subfield[@code='6'][subfield[@code='h']]">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x256">
			<xsl:for-each
				select="datafield[@tag='256'][subfield[@code='a']]/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x300">
			<xsl:for-each select="datafield[@tag='300']/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
		...
		<xsl:variable name="x856">
			<xsl:for-each
				select="datafield[@tag='256'][subfield[@code='q']]/subfield[@code='6']">
				<xsl:variable name="altGrpStr" select="normalize-space(.)"/>
				<xsl:variable name="altGrp" select="substring($altGrpStr, 5, 2)"/>
				<xsl:value-of select="$altGrp"/>
			</xsl:for-each>
	...
	<xsl:template
		...
		<extent>
			<!-- 3.5 2.18 20142011 -->
			<xsl:if test="subfield[@code='f']"><xsl:attribute name="unit"><xsl:value-of select="local:subfieldSelect(.,'f')"/></xsl:attribute></xsl:if>
	...
	-->
	<xsl:template
		match="datafield[@tag='130']/subfield[@code='h'] 
	...
	<!-- 520 Create abstract -->
	<xsl:template
		match="datafield[@tag='520'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'520')]"
		mode="abstract">
		<abstract>
	...
	<xsl:template
		match="datafield[@tag='505'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'505')]"
		mode="toc">
		<tableOfContents>
	...
	<xsl:template
		match="datafield[@tag='521'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'521')]"
		mode="targetAudience">
		<targetAudience>
	...
	<xsl:template
		match="datafield[@tag='506'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'506')]"
		mode="accessConditions">
	...
	<xsl:template
		match="datafield[@tag='540'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'540')]"
		mode="accessConditions">
	...
	<xsl:template
		match="datafield[@tag='362'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'362')]"
		mode="note">
	...
	<xsl:template
		match="datafield[@tag='502'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'502')]"
		mode="note">
		<note type="thesis">
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
	...
	<xsl:template
		match="datafield[@tag='504'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'504')]"
		mode="note">
	...
	<xsl:template
		match="datafield[@tag='508'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'508')]"
		mode="note">
	...
	<xsl:template
		match="datafield[@tag='511'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'511')]"
		mode="note">
	...
	<xsl:template
		match="datafield[@tag='515'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'515')]"
		mode="note">
		<note type="numbering">
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
	...
	<xsl:template
		match="datafield[@tag='518'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'518')]"
		mode="note">
		<note type="venue">
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
	...
	<xsl:template
		match="datafield[@tag='524'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'524')]"
		mode="note">
	...
	<xsl:template
		match="datafield[@tag='530'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'530')]"
		mode="note">
	...
	<xsl:template
		match="datafield[@tag='533'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'533')]"
		mode="note">
	...
	<xsl:template
		match="datafield[@tag='535'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'535')]"
		mode="note">
	...
	<xsl:template
		match="datafield[@tag='536'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'536')]"
		mode="note">
		<note type="funding">
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
	...
	<xsl:template
		match="datafield[@tag='538'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'538')]"
		mode="note">
	...
	<xsl:template
		match="datafield[@tag='541'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'541')]"
		mode="note">
	...
	<xsl:template
		match="datafield[@tag='545'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'545')]"
		mode="note">
	...
	<xsl:template
		match="datafield[@tag='546'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'546')]"
		mode="note">
		<note type="language">
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
	...
	<xsl:template
		match="datafield[@tag='561'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'561')]"
		mode="note">
		<note type="ownership">
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
	...
	<xsl:template
		match="datafield[@tag='562'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'562')]"
		mode="note">
	...
	<xsl:template
		match="datafield[@tag='581'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'581')]"
		mode="note">
	...
	<xsl:template
		match="datafield[@tag='583'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'583')]"
		mode="note">
		<note type="action">
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
	...
	<xsl:template
		match="datafield[@tag='585'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'585')]"
		mode="note">
	...
	<!-- General Note field -->
	<xsl:template
		match="datafield[@tag='500'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'500')]
		| datafield[@tag='501'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'501')]
		| datafield[@tag='507'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'507')]
		| datafield[@tag='513'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'513')]
		| datafield[@tag='514'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'514')]
		| datafield[@tag='516'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'516')]
		| datafield[@tag='522'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'522')]
		| datafield[@tag='525'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'525')]
		| datafield[@tag='526'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'526')]
		| datafield[@tag='542'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'542')]
		| datafield[@tag='544'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'544')]
		| datafield[@tag='547'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'547')]
		| datafield[@tag='550'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'550')]
		| datafield[@tag='552'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'552')]
		| datafield[@tag='555'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'555')]
		| datafield[@tag='556'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'556')]
		| datafield[@tag='563'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'563')]
		| datafield[@tag='565'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'565')]
		| datafield[@tag='567'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'567')]
		| datafield[@tag='580'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'580')]
		| datafield[@tag='584'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'584')]
		| datafield[@tag='586'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'586')]
		| datafield[@tag='588'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'588')]
		| datafield[starts-with(@tag,'59')] | datafield[@tag='880'][starts-with(subfield[@code='6'],'59')]"
		mode="note">
		<note>
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="uri"/>
			<xsl:for-each select="subfield[not(@code='6' or @code='8')]">
				<xsl:apply-templates/>
	...
	<xsl:template mode="note" match="datafield"/>

	<!-- Create subjects -->
	<!-- 034 cartographics -->
	<xsl:template
		match="datafield[@tag='034'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'034')]"
		mode="subject">
		<xsl:if test="subfield[@code='d' or @code='e' or @code='f' or @code='g']">
			<subject>
				<!-- Template checks for altRepGroup - 880 $6 -->
				<xsl:call-template name="xxx880"/>
				<cartographics>
	...
	<xsl:template
		match="datafield[@tag='255'][child::*[@code='a' or @code='b' or @code='c']]
		| datafield[@tag='880'][starts-with(subfield[@code='6'],'255')][child::*[@code='a' or @code='b' or @code='c']]"
		mode="subject">
		<subject>
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
	...
	<!-- 043 geographicCode -->
	<xsl:template
		match="datafield[@tag='043']| datafield[@tag='880'][starts-with(subfield[@code='6'],'043')]"
		mode="subject">
		<subject>
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
	...
	<xsl:template
		match="datafield[@tag='045'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'045')]"
		mode="subject">
		<subject>
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
			<xsl:for-each select="subfield[@code='b' or @code='c']">
				<temporal>
					...
					<xsl:if
						test="parent::*[@ind1='2'] and position() = 1 and count(../subfield[@code='b']) &gt; 1">
						<xsl:attribute name="point">start</xsl:attribute>
					</xsl:if>
					<xsl:if
						test="parent::*[@ind1='2'] and position() = 2 and count(../subfield[@code='b']) &gt; 1">
	...
	<!-- 600 610 611 name -->
	<xsl:template
		match="datafield[@tag='600'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'600')]"
		mode="subject">
		<subject>
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
			...
			<name type="personal">
				...
				<xsl:apply-templates select="subfield[@code='b' or @code='c']"
					mode="termsOfAddress"/>
				<!-- namePart subfields -->
				<xsl:apply-templates select="subfield[@code='a']" mode="namePart"/>
				<!-- namePart date subfield -->
				<xsl:apply-templates select="subfield[@code='d']" mode="nameDate"/>
				<!-- affiliation -->
				<xsl:apply-templates select="subfield[@code='u']" mode="affiliation"/>
				<!-- role -->
				<xsl:apply-templates select="subfield[@code='e'] | subfield[@code='4']"
			...
			<!-- title as subject -->
			<xsl:apply-templates select="subfield[@code='t']" mode="subjectTitle"/>
			<!-- Additional subjects -->
			<xsl:apply-templates
	...
	<xsl:template
		match="datafield[@tag='610'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'610')]"
		mode="subject">
		<subject>
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
			...
			<name type="corporate">
				<!-- namePart -->
				<xsl:apply-templates select="subfield[@code='a']" mode="namePart"/>
				<xsl:apply-templates select="subfield[@code='b']" mode="namePart"/>
				<!-- namePart -->
	...
	<xsl:template
		match="datafield[@tag='611'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'611')]"
		mode="subject">
		<subject>
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
			...
			<name type="conference">
				...
				<!-- role -->
				<xsl:apply-templates select="subfield[@code='4']" mode="role"/>
			</name>
			<!-- title as subject -->
			<xsl:apply-templates select="subfield[@code='t']" mode="subjectTitle"/>
			<!-- Additional subjects -->
	...
	<!-- 630: subject title -->
	<xsl:template
		match="datafield[@tag='630'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'630')]"
		mode="subject">
		<subject>
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
			...
			<titleInfo>
				...
				<xsl:apply-templates select="subfield[@code='n']" mode="titleInfo"/>
				<xsl:apply-templates select="subfield[@code='p']" mode="titleInfo"/>
			</titleInfo>
			<!-- Additional subjects -->
			<xsl:apply-templates
				select="subfield[@code='v' or @code='x' or @code='y' or @code='z']"
	...
	<xsl:template
		match="datafield[@tag='648'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'648')]"
		mode="subject">
		<subject>
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
	...
	<!-- 650: subject topic -->
	<xsl:template
		match="datafield[@tag='650'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'650')]"
		mode="subject">
		<subject>
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
	...
	<xsl:template
		match="datafield[@tag='651'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'651')]"
		mode="subject">
		<subject>
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
	...
	<xsl:template
		match="datafield[@tag='653'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'653')]"
		mode="subject">
	...
	<xsl:template
		match="datafield[@tag='656'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'656')]"
		mode="subject">
		<subject>
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
	...
	<xsl:template
		match="datafield[@tag='662'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'662')] 
		| datafield[@tag='752'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'752')]"
		mode="subject">
		<subject>
			<!-- Template checks for altRepGroup - 880 $6 -->
			...
			<hierarchicalGeographic>
				...
				<xsl:if test="subfield[@code='0']">
					<xsl:attribute name="valueURI"><xsl:value-of select="subfield[@code='0']"/></xsl:attribute>
				</xsl:if>
				<xsl:for-each select="subfield[@code='a']">
					<country>
						<xsl:value-of select="local:stripPunctuation(.)"/>
	...
	<xsl:template match="subfield[@code='a'] | subfield[@code='b']" mode="namePart">
		<namePart>
			<xsl:choose>
	...
	<xsl:template match="subfield[@code='b' or @code='c']" mode="termsOfAddress">
		<namePart type="termsOfAddress">
			<xsl:value-of select="local:stripPunctuation(.,',:;/ ')"/>
		</namePart>
	</xsl:template>
	<!-- subfield b: name type='date' -->
	<xsl:template match="subfield[@code='d']" mode="nameDate">
		<namePart type="date">
			<xsl:value-of select="local:stripPunctuation(.)"/>
		</namePart>
	</xsl:template>
	<!-- subfield u: affiliation -->
	<xsl:template match="subfield[@code='u']" mode="affiliation">
		<affiliation>
			<xsl:apply-templates/>
		</affiliation>
	</xsl:template>
	<!-- subfields e and 4: role -->
	<xsl:template match="subfield[@code='e' or @code='4']" mode="role">
		<role>
			<roleTerm>
				<xsl:choose>
					<xsl:when test="@code='e'">
	...
	<!-- 2.31 -->
	<xsl:template match="subfield[@code='0']" mode="identifier">
		<nameIdentifier>
			<xsl:value-of select="."/>
		</nameIdentifier>
	</xsl:template>
	<!-- subfield v: genre -->
	<xsl:template match="subfield[@code='v']" mode="subject">
		<genre>
			<xsl:value-of select="local:stripPunctuation(.)"/>
		</genre>
	</xsl:template>
	<!-- subfield x: topic -->
	<xsl:template match="subfield[@code='x']" mode="subject">
		<topic>
			<xsl:value-of select="local:stripPunctuation(.)"/>
		</topic>
	</xsl:template>
	<!-- subfield y: temporal -->
	<xsl:template match="subfield[@code='y']" mode="subject">
		<temporal>
			<xsl:value-of select="local:stripPunctuation(.)"/>
		</temporal>
	</xsl:template>
	<!-- subfield z: geographic -->
	<xsl:template match="subfield[@code='z']" mode="subject">
		<geographic>
			<xsl:value-of select="local:stripPunctuation(.)"/>
		</geographic>
	</xsl:template>
	<!-- subfield t: titleInfo -->
	<xsl:template match="subfield[@code='t']" mode="subjectTitle">
		<titleInfo>
			<title>
				<xsl:value-of select="local:stripPunctuation(.)"/>
			</title>
	...
	<xsl:template
		match="datafield[@tag='050'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'050')]"
		mode="classification">
		<xsl:for-each
			select="subfield[@code='b'] | (subfield[@code='a'][not(following-sibling::subfield[@code='b'])])">
	...
	<xsl:template
		match="datafield[@tag='060'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'060')]"
		mode="classification">
	...
	<xsl:template
		match="datafield[@tag='080'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'080')]"
		mode="classification">
	...
	<xsl:template
		match="datafield[@tag='082'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'082')]"
		mode="classification">
	...
	<xsl:template
		match="datafield[@tag='084'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'084')]"
		mode="classification">
		<classification>
			<xsl:attribute name="authority">
				<xsl:value-of select="subfield[@code='2']"/>
	...
	<xsl:template
		match="datafield[@tag='086'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'086')]"
		mode="classification">
		<classification>
			<xsl:choose>
				<xsl:when test="@ind1='0'">
	...
	<xsl:template
		match="datafield[@tag='852'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'852')]"
		mode="location">
		<location>
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
			<xsl:if test="subfield[@code='a' or @code='b' or @code='e' or  @code='u']">
				<physicalLocation>
					<xsl:if test="subfield[@code='3']">
						<xsl:attribute name="displayLabel">
							<xsl:value-of select="subfield[@code='3']"/>
	...
	<xsl:template
		match="datafield[@tag='856'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'856')]"
		mode="location">
		<xsl:if test="@ind2!='2' and subfield[@code='u']">
			<location>
				<!-- Template checks for altRepGroup - 880 $6 -->
				<xsl:call-template name="xxx880"/>
	...
	<!-- @880$6 -->
	<xsl:template match="datafield[@tag='490'][@ind1='0' or @ind1=' '] | datafield[@tag='880'][@ind1='0' or @ind1=' '][starts-with(subfield[@code='6'],'490')]" mode="relatedItem">
			...
			<xsl:for-each
				...
				<titleInfo>
					...
					<xsl:if test="subfield[@code='v']">
						<partNumber>
							<xsl:value-of select="local:stripPunctuation(subfield[@code='v'])"/>
						</partNumber>
					</xsl:if>
				</titleInfo>
			</xsl:for-each>
	...
	<!-- @880$6 -->
	<xsl:template match="datafield[@tag='440'] | datafield[@tag='880'][@ind1='0' or @ind1=' '][starts-with(subfield[@code='6'],'440')]" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		<xsl:if test="@tag=440 or (@tag='880' and not(../datafield[@tag='440'][@ind1='0' or @ind1=' '][substring(subfield[@code='6'],5,2) = $s6]))">
		<relatedItem type="series">
			<xsl:for-each
				select=". | ../datafield[@tag='880'][starts-with(subfield[@code='6'],'440')][substring(subfield[@code='6'],5,2) = $s6]">
				<titleInfo>
					<!-- Template checks for altRepGroup - 880 $6 -->
					<xsl:call-template name="xxx880"/>
					<!-- 2.32 - @440$a$v -->
	...
	<!-- @880$6 -->
	<xsl:template match="datafield[@tag='510'][@ind1='0' or @ind1=' '] | datafield[@tag='880'][@ind1='0' or @ind1=' '][starts-with(subfield[@code='6'],'510')]" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
	...
	<!-- @880$6 -->
	<xsl:template match="datafield[@tag='534'][@ind1='0' or @ind1=' '] | datafield[@tag='880'][@ind1='0' or @ind1=' '][starts-with(subfield[@code='6'],'534')]" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		...
		<relatedItem type="original">
			<xsl:for-each
				...
				<!-- originInfo -->
				<xsl:if test="subfield[@code='b'] or subfield[@code='c']">
					<originInfo>
						<xsl:call-template name="xxx880"/>
						<xsl:for-each select="subfield[@code='c']">
							<publisher>
	...
	<!-- @880$6 -->
	<xsl:template match="datafield[@tag='700'][subfield[@code='t']] | datafield[@tag='880'][subfield[@code='t']][starts-with(subfield[@code='6'],'700')]" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		...
		<relatedItem>
			...
			<!-- 2.30 -->
			<xsl:if test="subfield[@code='i']">
				<xsl:attribute name="otherType"><xsl:value-of select="subfield[@code='i']"/></xsl:attribute>
			</xsl:if>
			<xsl:for-each
				...
				<name type="personal">
					...
					<xsl:apply-templates select="subfield[@code='b']" mode="termsOfAddress"/>
					<!-- 2.32 - @700$c -->
					<xsl:apply-templates select="subfield[@code='c']" mode="termsOfAddress"/>
					<xsl:apply-templates select="subfield[@code='d']" mode="nameDate"/>
					<xsl:apply-templates
						select="subfield[@code='e'] | subfield[@code='4']" mode="role"/>
				</name>
	...
	<!-- @880$6 -->
	<xsl:template match="datafield[@tag='710'][subfield[@code='t']] | datafield[@tag='880'][subfield[@code='t']][starts-with(subfield[@code='6'],'710')]" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
	...
	<!-- @880$6 -->
	<xsl:template match="datafield[@tag='711'][subfield[@code='t']] | datafield[@tag='880'][starts-with(subfield[@code='6'],'711')][subfield[@code='t']]" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
	...
	<!-- @880$6 -->
	<xsl:template match="datafield[@tag='730'][@ind2='2'] | datafield[@tag='880'][@ind2='2'][starts-with(subfield[@code='6'],'730')]" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
	...
	<!-- @880$6 -->
	<xsl:template match="datafield[@tag='740'][@ind2='2'] | datafield[@tag='880'][@ind2='2'][starts-with(subfield[@code='6'],'740')]" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
	...
	<!-- @880$6 -->
	<!--2.32 - @777,@787 -->
	<xsl:template match="datafield[@tag='760'] | datafield[@tag='762'] | datafield[@tag='765'] | 
		datafield[@tag='767'] | datafield[@tag='770'] | datafield[@tag='774'] | 
		datafield[@tag='775'] | datafield[@tag='772'] | datafield[@tag='773'] |
		datafield[@tag='776'] | datafield[@tag='777'] | datafield[@tag='787'] | 
		datafield[@tag='780'] | datafield[@tag='785'] | datafield[@tag='786'] | 
	...
	<!-- @880$6 -->
	<xsl:template match="datafield[@tag='800'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'800')]" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
	...
	<!-- @880$6 -->
	<xsl:template match="datafield[@tag='810'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'810')]" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
	...
	<!-- @880$6 -->
	<xsl:template match="datafield[@tag='811'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'811')]" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
	...
	<!-- @880$6 -->
	<xsl:template match="datafield[@tag='830'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'830')]" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
	...
	<!-- @880$6 -->
	<xsl:template match="datafield[@tag='856'][@ind2='2'] | datafield[@tag='880'][@ind2='2'][starts-with(subfield[@code='6'],'856')]" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		<xsl:if test="@tag=856 or (@tag='880' and not(../datafield[@tag='856'][@ind2='2'][substring(subfield[@code='6'],5,2) = $s6]))">
		<relatedItem>
			<xsl:for-each
	...
	<xsl:template match="subfield[@code='g']" mode="relatedItem">
		<xsl:if
			test="parent::datafield[@tag='760' or @tag='762' or @tag='765' 
	...
	<!-- Create Identifiers -->
	<xsl:template
		match="datafield[@tag='020'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'020')]"
		mode="id">
		<identifier>
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
			<!-- Add attribute type -->
			<xsl:if test="subfield[@code='a' or @code='z']">
	...
	<xsl:template
		match="datafield[@tag='024'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'024')]"
		mode="id">
		<xsl:if test="subfield[@code='a' or @code='2']">
			<identifier>
				<!-- Template checks for altRepGroup - 880 $6 -->
				<xsl:call-template name="xxx880"/>
				...
				<xsl:choose>
					...
					<xsl:when test="@ind1='7' and subfield[@code='2']">
						<xsl:attribute name="type">
							<xsl:value-of select="subfield[@code='2']"/>
						</xsl:attribute>
					</xsl:when>
	...
	<xsl:template match="datafield[@tag='022']" mode="id">
		<xsl:if test="subfield[@code='a']">
			<identifier type="issn">
				<!-- Template checks for altRepGroup - 880 $6 -->
				<xsl:call-template name="xxx880"/>
	...
	<xsl:template
		match="datafield[@tag='010'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'010')]"
		mode="id">
		<xsl:for-each select="subfield[@code='a']">
	...
	<xsl:template
		match="datafield[@tag='028'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'028')]"
		mode="id">
		<identifier>
			<!-- Template checks for altRepGroup - 880 $6 -->
			<xsl:call-template name="xxx880"/>
	...
	<xsl:template match="datafield[@tag='035']" mode="id">
		<xsl:for-each select="subfield[@code='a'][contains(., '(OCoLC)')]">
			<identifier type="oclc">
				<xsl:value-of select="normalize-space(substring-after(., '(OCoLC)'))"/>
			</identifier>
		</xsl:for-each>
		<!-- 3.5 2.21 20140421 -->
		<xsl:for-each select="datafield[@tag='035'][subfield[@code='a'][contains(text(), '(WlCaITV)')]]">
			<identifier type="WlCaITV">
				<xsl:value-of select="normalize-space(substring-after(subfield[@code='a'], '(WlCaITV)'))"/>
			</identifier>
		</xsl:for-each>
	</xsl:template>
	
	<xsl:template
		match="datafield[@tag='037'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'037')]"
		mode="id">
	...
	<xsl:template
		match="datafield[@tag='856']/subfield[@code='u'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'856')]/subfield[@code='u']"
		mode="id">
		<xsl:choose>
			<xsl:when
	...
	<xsl:template name="nameTitleGroup">
		<xsl:choose>
			...
			<xsl:when
				...
				<xsl:choose>
					<xsl:when
						test="../datafield[@tag='880'][starts-with(subfield[@code='6'],'100')] or 
			...
			<xsl:when
				test="(self::datafield[@tag='880'][starts-with(subfield[@code='6'],'100')]
