<xsl:stylesheet xmlns="http://www.loc.gov/mods/v3" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="xlink marc" version="1.0">
	...
	<xsl:template name="marcRecord">
		<xsl:variable name="marcLeader" select="marcLeader"/>
		...
		<!-- titleInfo -->
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag='245'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'245')]">
			<xsl:call-template name="createTitleInfoFrom245"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag='210'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'210')]">
			<xsl:call-template name="createTitleInfoFrom210"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag='246'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'246')]">
			<xsl:call-template name="createTitleInfoFrom246"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag='240'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'240')]">
			<xsl:call-template name="createTitleInfoFrom240"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag='740'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'740')]">
			<xsl:call-template name="createTitleInfoFrom740"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag='130'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'130')]">
			<xsl:call-template name="createTitleInfoFrom130"/>
		</xsl:for-each>
		<!-- 1.121, 1.131-->
		<xsl:for-each select="datafield[@tag='730'][@ind2 !='2'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'730')][@ind2 !='2']">
		...
		<!-- name -->
		<!-- 1.121 --><!-- 1.108  -->
		<xsl:for-each select="datafield[@tag='100'][not(subfield[@code='t'])] | datafield[@tag='880'][starts-with(subfield[@code='6'],'100')][not(subfield[@code='t'])]">
			<xsl:call-template name="createNameFrom100"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag='110'][not(subfield[@code='t'])] | datafield[@tag='880'][starts-with(subfield[@code='6'],'110')][not(subfield[@code='t'])]">
			<xsl:call-template name="createNameFrom110"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag='111'][not(subfield[@code='t'])] | datafield[@tag='880'][starts-with(subfield[@code='6'],'111')][not(subfield[@code='t'])]">
			<xsl:call-template name="createNameFrom111"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag='700'][not(subfield[@code='t'])] | datafield[@tag='880'][starts-with(subfield[@code='6'],'700')][not(subfield[@code='t'])]">
			<xsl:call-template name="createNameFrom700"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag='710'][not(subfield[@code='t'])] | datafield[@tag='880'][starts-with(subfield[@code='6'],'710')][not(subfield[@code='t'])]">
			<xsl:call-template name="createNameFrom710"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag='711'][not(subfield[@code='t'])] | datafield[@tag='880'][starts-with(subfield[@code='6'],'711')][not(subfield[@code='t'])]">
			<xsl:call-template name="createNameFrom711"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag='720'][not(subfield[@code='t'])] | datafield[@tag='880'][starts-with(subfield[@code='6'],'720')][not(subfield[@code='t'])]">
...
<!-- 111$n, 711$n 1.103 -->	
		...
		<!-- genre -->
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=047] | datafield[@tag='880'][starts-with(subfield[@code='6'],'047')]">
			<xsl:call-template name="createGenreFrom047"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=336] | datafield[@tag='880'][starts-with(subfield[@code='6'],'336')]">
			<xsl:call-template name="createGenreFrom336"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=655] | datafield[@tag='880'][starts-with(subfield[@code='6'],'655')]">
...
-->
		...
		<!-- originInfo - 264 -->
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=264][@ind2=0] | datafield[@tag='880'][starts-with(subfield[@code='6'],'264')][@ind2=0]">
			<!-- 1.120 - @264/ind2 -->
		...
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=264][@ind2=1] | datafield[@tag='880'][starts-with(subfield[@code='6'],'264')][@ind2=1]">
			<!-- 1.120 - @264/ind2 -->
		...
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=264][@ind2=2] | datafield[@tag='880'][starts-with(subfield[@code='6'],'264')][@ind2=2]">
			<!-- 1.120 - @264/ind2 -->
		...
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=264][@ind2=3] | datafield[@tag='880'][starts-with(subfield[@code='6'],'264')][@ind2=3]">
			<!-- 1.120 - @264/ind2 -->
...
-->
		...
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=520] | datafield[@tag='880'][starts-with(subfield[@code='6'],'520')]">
			<xsl:call-template name="createAbstractFrom520"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=505] | datafield[@tag='880'][starts-with(subfield[@code='6'],'505')]">
			<xsl:call-template name="createTOCFrom505"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=521] | datafield[@tag='880'][starts-with(subfield[@code='6'],'521')]">
			<xsl:call-template name="createTargetAudienceFrom521"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=506] | datafield[@tag='880'][starts-with(subfield[@code='6'],'506')]">
			<xsl:call-template name="createAccessConditionFrom506"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=540] | datafield[@tag='880'][starts-with(subfield[@code='6'],'540')]">
		...
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=362] | datafield[@tag='880'][starts-with(subfield[@code='6'],'362')]">
			<xsl:call-template name="createNoteFrom362"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=500] | datafield[@tag='880'][starts-with(subfield[@code='6'],'500')]">
			<xsl:call-template name="createNoteFrom500"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=502] | datafield[@tag='880'][starts-with(subfield[@code='6'],'502')]">
			<xsl:call-template name="createNoteFrom502"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=504] | datafield[@tag='880'][starts-with(subfield[@code='6'],'504')]">
			<xsl:call-template name="createNoteFrom504"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=508] | datafield[@tag='880'][starts-with(subfield[@code='6'],'508')]">
			<xsl:call-template name="createNoteFrom508"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=511] | datafield[@tag='880'][starts-with(subfield[@code='6'],'511')]">
			<xsl:call-template name="createNoteFrom511"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=515] | datafield[@tag='880'][starts-with(subfield[@code='6'],'515')]">
			<xsl:call-template name="createNoteFrom515"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=518] | datafield[@tag='880'][starts-with(subfield[@code='6'],'518')]">
			<xsl:call-template name="createNoteFrom518"/>
			
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=524] | datafield[@tag='880'][starts-with(subfield[@code='6'],'524')]">
			<xsl:call-template name="createNoteFrom524"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=530] | datafield[@tag='880'][starts-with(subfield[@code='6'],'530')]">
			<xsl:call-template name="createNoteFrom530"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=533] | datafield[@tag='880'][starts-with(subfield[@code='6'],'533')]">
			<xsl:call-template name="createNoteFrom533"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=535] | datafield[@tag='880'][starts-with(subfield[@code='6'],'535')]">
			<xsl:call-template name="createNoteFrom535"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=536] | datafield[@tag='880'][starts-with(subfield[@code='6'],'536')]">
			<xsl:call-template name="createNoteFrom536"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=538] | datafield[@tag='880'][starts-with(subfield[@code='6'],'538')]">
			<xsl:call-template name="createNoteFrom538"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=541] | datafield[@tag='880'][starts-with(subfield[@code='6'],'541')]">
			<xsl:call-template name="createNoteFrom541"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=545] | datafield[@tag='880'][starts-with(subfield[@code='6'],'545')]">
			<xsl:call-template name="createNoteFrom545"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=546] | datafield[@tag='880'][starts-with(subfield[@code='6'],'546')]">
			<xsl:call-template name="createNoteFrom546"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=561] | datafield[@tag='880'][starts-with(subfield[@code='6'],'561')]">
			<xsl:call-template name="createNoteFrom561"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=562] | datafield[@tag='880'][starts-with(subfield[@code='6'],'562')]">
			<xsl:call-template name="createNoteFrom562"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=581] | datafield[@tag='880'][starts-with(subfield[@code='6'],'581')]">
			<xsl:call-template name="createNoteFrom581"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=583] | datafield[@tag='880'][starts-with(subfield[@code='6'],'583')]">
			<xsl:call-template name="createNoteFrom583"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=585] | datafield[@tag='880'][starts-with(subfield[@code='6'],'585')]">
			<xsl:call-template name="createNoteFrom585"/>
		</xsl:for-each>
		<!-- 1.121, 1.135 -->
		<xsl:for-each select="datafield[@tag=501 or @tag=507 or @tag=513 or @tag=514 or @tag=516 
		...
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=034] | datafield[@tag='880'][starts-with(subfield[@code='6'],'034')]">
			<xsl:call-template name="createSubGeoFrom034"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=043] | datafield[@tag='880'][starts-with(subfield[@code='6'],'043')]">
			<xsl:call-template name="createSubGeoFrom043"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=045] | datafield[@tag='880'][starts-with(subfield[@code='6'],'045')]">
			<xsl:call-template name="createSubTemFrom045"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=255] | datafield[@tag='880'][starts-with(subfield[@code='6'],'255')]">
			<xsl:call-template name="createSubGeoFrom255"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=600] | datafield[@tag='880'][starts-with(subfield[@code='6'],'600')]">
			<xsl:call-template name="createSubNameFrom600"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=610] | datafield[@tag='880'][starts-with(subfield[@code='6'],'610')]">
			<xsl:call-template name="createSubNameFrom610"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=611] | datafield[@tag='880'][starts-with(subfield[@code='6'],'611')]">
			<xsl:call-template name="createSubNameFrom611"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=630] | datafield[@tag='880'][starts-with(subfield[@code='6'],'630')]">
			<xsl:call-template name="createSubTitleFrom630"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=648] | datafield[@tag='880'][starts-with(subfield[@code='6'],'648')]">
			<xsl:call-template name="createSubChronFrom648"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=650] | datafield[@tag='880'][starts-with(subfield[@code='6'],'650')]">
			<xsl:call-template name="createSubTopFrom650"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=651] | datafield[@tag='880'][starts-with(subfield[@code='6'],'651')]">
			<xsl:call-template name="createSubGeoFrom651"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=653] | datafield[@tag='880'][starts-with(subfield[@code='6'],'653')]">
			<xsl:call-template name="createSubFrom653"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=656] | datafield[@tag='880'][starts-with(subfield[@code='6'],'656')]">
			<xsl:call-template name="createSubFrom656"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=662] | datafield[@tag='880'][starts-with(subfield[@code='6'],'662')]">
			<xsl:call-template name="createSubGeoFrom662752"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=752] | datafield[@tag='880'][starts-with(subfield[@code='6'],'752')]">
			<xsl:call-template name="createSubGeoFrom662752"/>
		</xsl:for-each>

		<!-- createClassificationFrom 0XX-->
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag='050'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'050')]">
			<xsl:call-template name="createClassificationFrom050"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag='060'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'060')]">
			<xsl:call-template name="createClassificationFrom060"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag='080'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'080')]">
			<xsl:call-template name="createClassificationFrom080"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag='082'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'082')]">
			<xsl:call-template name="createClassificationFrom082"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag='084'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'084')]">
			<xsl:call-template name="createClassificationFrom084"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag='086'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'086')]">
			<xsl:call-template name="createClassificationFrom086"/>
		</xsl:for-each>

		<!--	location	-->
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=852] | datafield[@tag='880'][starts-with(subfield[@code='6'],'852')]">
			<xsl:call-template name="createLocationFrom852"/>
		</xsl:for-each>
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=856] | datafield[@tag='880'][starts-with(subfield[@code='6'],'856')]">
			<xsl:call-template name="createLocationFrom856"/>
		</xsl:for-each>

		<!-- 1.120 - @490$ind1 -->
		<xsl:for-each select="datafield[@tag=490][@ind1='0' or @ind1=' '] | datafield[@tag='880'][@ind1='0' or @ind1=' '][starts-with(subfield[@code='6'],'490')]">
			<xsl:call-template name="createRelatedItemFrom490"/>
		</xsl:for-each>

		<!-- 1.120 - @440$ind1 --><!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=440][@ind1='0' or @ind1=' '] | datafield[@tag='880'][@ind1='0' or @ind1=' '][starts-with(subfield[@code='6'],'440')]">
		...
		<xsl:for-each select="datafield[@tag=510][@ind1='0' or @ind1=' '] | datafield[@tag='880'][@ind1='0' or @ind1=' '][starts-with(subfield[@code='6'],'510')]">
			<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		...
		<xsl:for-each select="datafield[@tag=534][@ind1='0' or @ind1=' '] | datafield[@tag='880'][@ind1='0' or @ind1=' '][starts-with(subfield[@code='6'],'534')]">
			<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		...
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=700][subfield[@code='t']] | datafield[@tag='880'][starts-with(subfield[@code='6'],'700')][subfield[@code='t']]">
			<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		...
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=710][subfield[@code='t']] | datafield[@tag='880'][starts-with(subfield[@code='6'],'710')][subfield[@code='t']]">
			<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		...
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=711][subfield[@code='t']] | datafield[@tag='880'][starts-with(subfield[@code='6'],'711')][subfield[@code='t']]">
			<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		...
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=740][@ind2=2] | datafield[@tag='880'][starts-with(subfield[@code='6'],'740')][@ind2='2']">
			<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		...
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=800] | datafield[@tag='880'][starts-with(subfield[@code='6'],'800')]">
			<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		...
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=810] | datafield[@tag='880'][starts-with(subfield[@code='6'],'810')]">
			<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		...
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=811] | datafield[@tag='880'][starts-with(subfield[@code='6'],'811')]">
			<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		...
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag='830'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'830')]">
			<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>	
		...
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag='856'][@ind2='2']/subfield[@code='q'] | datafield[@tag='880'][@ind2='2'][subfield[@code='q']][starts-with(subfield[@code='6'],'856')]">
			<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		...
		<!-- 1.121 -->
		<xsl:for-each select="datafield[@tag=856][@ind2=2][subfield[@code='u']] | datafield[@tag='880'][@ind2=2][subfield[@code='u']][starts-with(subfield[@code='6'],'856')]">
			<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
			<xsl:if test="@tag=856 or (@tag='880' and not(../datafield[@tag='856'][@ind2=2][subfield[@code='u']][substring(subfield[@code='6'],5,2) = $s6]))">
			<relatedItem>
				<location>
					<url>
						<xsl:if test="subfield[@code='y' or @code='3']">
...
<!-- tmee 1.93 20140130 -->
	...
	<xsl:template
		...
		<extent>
			<!-- 3.5 2.18 20142011 -->
			<xsl:if test="subfield[@code='f']"><xsl:attribute name="unit">
				<xsl:call-template name="subfieldSelect">
			...
			<xsl:otherwise>
				<xsl:if
					...
					<originInfo>
						<xsl:call-template name="z2xx880"/>
						<xsl:copy-of select="$originInfoShared"/>
						<xsl:apply-templates select="datafield[@tag='044']/subfield[@code='c']" mode="originInfo"/>
