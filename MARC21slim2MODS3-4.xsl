<xsl:stylesheet xmlns="http://www.loc.gov/mods/v3" xmlns:f="http://functions" xmlns:marc="http://www.loc.gov/MARC21/slim"
...
-->
		...
		<xsl:for-each select="marc:datafield[@tag=546]| marc:datafield[@tag=546]">
		...
		<xsl:for-each select="marc:datafield[@tag=045] | datafield[@tag=045]">		<xsl:call-template name="createSubTemFrom045"/>
		</xsl:for-each>
