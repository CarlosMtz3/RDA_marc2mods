<xsl:stylesheet xmlns="http://www.loc.gov/mods/v3"
	...
	<!--NAL Revision
		NAL Revision 2.20 - Added "current()" function to local:functions to prevent
		NAL Revision 2.19 - Removed "marc:" prefix from tempalates to accomodate for Alma export. -->
	...
	-->
	<!-- NAL Revision 1.01 - Added current() function to apply-templates ijn codeString variable to prevent typeError-->
	...
	<!-- 
		...
		$beforeCodes: subfields that occur before the axis
		$afterCodes: subfields that occur after the axis
	-->
	<!-- NAL Revision 1.01 - Added current() function to anyCodes parameter in apply-templates w/in codeString variable to prevent typeError-->
	...
	<xsl:template match="record">
		...
		<mods version="3.4">
			...
			<xsl:apply-templates
				...
				mode="titleInfo"/>
			<xsl:apply-templates
				select="datafield[@tag='740'][@ind2 !='2'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'740')]"
				mode="titleInfo"/>
			<xsl:apply-templates
				select="datafield[@tag='730'][@ind2 !='2'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'730')]"
				mode="titleInfo"/>
			<!-- titleInfo type="translated" -->
			...
			<!--			<xsl:apply-templates select="datafield[@tag='880']"/>-->
			<xsl:apply-templates
				select="datafield[@tag='264'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'264')]"
				mode="orginInfo"/>
		...
		-->
			...
			<!-- series -->
			<xsl:apply-templates select="datafield[@tag='490'][@ind1='0']" mode="relatedItem"/>
			<xsl:apply-templates select="datafield[@tag='440']" mode="relatedItem"/>
			<!-- isReferencedBy -->
			<xsl:apply-templates select="datafield[@tag='510']" mode="relatedItem"/>
			<!-- original -->
			<xsl:apply-templates select="datafield[@tag='534']" mode="relatedItem"/>
			<xsl:apply-templates select="datafield[@tag='700'][subfield[@code='t']]"
				mode="relatedItem"/>
			<xsl:apply-templates select="datafield[@tag='710'][subfield[@code='t']]"
				mode="relatedItem"/>
			<xsl:apply-templates select="datafield[@tag='711'][subfield[@code='t']]"
				mode="relatedItem"/>
			<xsl:apply-templates select="datafield[@tag='730'][@ind2='2']" mode="relatedItem"/>
			<xsl:apply-templates select="datafield[@tag='740'][@ind2='2']" mode="relatedItem"/>
			<xsl:apply-templates
				select="datafield[@tag='760'] | datafield[@tag='765'] | 
				datafield[@tag='767'] | datafield[@tag='762'] | 
				datafield[@tag='770'] | datafield[@tag='774'] | datafield[@tag='775'] |
				datafield[@tag='772'] | datafield[@tag='773'] |
				datafield[@tag='776'] | datafield[@tag='780'] |
				datafield[@tag='785'] | datafield[@tag='786']"
				mode="relatedItem"/>
			<xsl:apply-templates select="datafield[@tag='800']" mode="relatedItem"/>
			<xsl:apply-templates select="datafield[@tag='810']" mode="relatedItem"/>
			<xsl:apply-templates select="datafield[@tag='811']" mode="relatedItem"/>
			<xsl:apply-templates select="datafield[@tag='830']" mode="relatedItem"/>
			<xsl:apply-templates select="datafield[@tag='856'][@ind2='2']" mode="relatedItem"/>
	...
	<xsl:template
		match="datafield[@tag='740'][@ind2 !='2'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'740')]"
		mode="titleInfo">
	...
	<xsl:template name="genre">
		...
		<xsl:apply-templates
			select="datafield[@tag='047'][@ind2='7'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'047')]"
			mode="genre"/>
	...
	<xsl:template
		match="datafield[@tag='047'][@ind2='7'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'047')]"
		mode="genre">
	...
	<xsl:template name="orginInfo">
		...
		<xsl:if
			...
			<originInfo>
				...
				<xsl:apply-templates select="datafield[@tag='044']/subfield[@code='c']"
					mode="orginInfo"/>
				<xsl:apply-templates select="datafield[@tag='260']/child::*" mode="orginInfo">
					<xsl:with-param name="leader6" select="$leader6"/>
				</xsl:apply-templates>

				<!-- Build date elements -->
				<xsl:apply-templates select="datafield[@tag='046']" mode="orginInfo"/>
				...
				<xsl:apply-templates select="datafield[@tag='033']" mode="orginInfo">
					<xsl:with-param name="leader6" select="$leader6"/>
				</xsl:apply-templates>

				<!-- Build edition element -->
				<xsl:apply-templates select="datafield[@tag='250']/subfield[@code='a']"
					mode="orginInfo"/>
		...
		<xsl:if
			test="datafield[@tag='880'][starts-with(subfield[@code='6'],'260')] 
			| datafield[@tag='880'][starts-with(subfield[@code='6'],'250')]/subfield[@code='a']
			...
			<originInfo>
				...
				<xsl:apply-templates
					select="datafield[@tag='880'][starts-with(subfield[@code='6'],'260')]/child::*"
					mode="orginInfo"/>
				<xsl:apply-templates
					select="datafield[@tag='880'][starts-with(subfield[@code='6'],'250')]/subfield[@code='a']"
					mode="orginInfo"/>
				<xsl:apply-templates
					select="datafield[@tag='880'][starts-with(subfield[@code='6'],'044')]/subfield[@code='c']"
					mode="orginInfo"/>
				<xsl:apply-templates
					select="datafield[@tag='880'][starts-with(subfield[@code='6'],'046')]"
					mode="orginInfo"/>
				<xsl:apply-templates
					select="datafield[@tag='880'][starts-with(subfield[@code='6'],'033')]"
					mode="orginInfo"/>
				<xsl:apply-templates
					select="datafield[@tag='880'][starts-with(subfield[@code='6'],'310')]"
					mode="orginInfo"/>
				<xsl:apply-templates
					select="datafield[@tag='880'][starts-with(subfield[@code='6'],'321')]"
					mode="orginInfo"/>
			</originInfo>
		</xsl:if>
	</xsl:template>
	<!-- 2.13 WS: added 264 to orginInfo -->
	<xsl:template match="datafield[@tag='264']" mode="orginInfo">
	...
	<!-- orginInfo place 044 -->
	<xsl:template
		match="datafield[@tag='044']/subfield[@code='c'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'044')]/subfield[@code='c']"
		mode="orginInfo">
		<place>
			<placeTerm>
				<xsl:attribute name="type">code</xsl:attribute>
	...
	<xsl:template
		match="datafield[@tag='260']/child::* | datafield[@tag='880'][starts-with(subfield[@code='6'],'260')]/child::*"
		mode="orginInfo">
		<xsl:param name="leader6"/>
		<xsl:choose>
	...
	<!-- orginInfo edition -->
	<xsl:template
		match="datafield[@tag='250']/subfield[@code='a'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'250')]/subfield[@code='a']"
		mode="orginInfo">
		<edition>
			<xsl:apply-templates/>
		</edition>
	...
	<xsl:template name="physicalDescription">
		...
		<xsl:param name="leader6"/>
		<xsl:if
			test="controlfield[@tag='007'] 
			or datafield[@tag='130' or @tag='240' or @tag='242' or @tag='245' or @tag='246' or @tag='730']/child::*[@code='h'] 
			or datafield[@tag='256']/child::*[@code='a'] 
			or datafield[@tag='300']/child::*[@code='a' or @code='b' or @coe='c' or @code='e']
			or datafield[@tag='351']/child::*[@code='3' or @code='a' or @coe='b' or @code='c']
			or datafield[@tag='285']/child::*[@code='q'] 
			or datafield[@tag='856']/child::*[@code='q']">
			<physicalDescription>
				<!--  880 field -->
		...
		<xsl:if
			test="datafield[@tag='880'][starts-with(subfield[@code='6'],'130')][child::*[@code='h']] or 
			datafield[@tag='880'][starts-with(subfield[@code='6'],'240')][child::*[@code='h']] or 
			datafield[@tag='880'][starts-with(subfield[@code='6'],'242')][child::*[@code='h']] or 
			datafield[@tag='880'][starts-with(subfield[@code='6'],'245')][child::*[@code='h']] or 
			datafield[@tag='880'][starts-with(subfield[@code='6'],'246')][child::*[@code='h']] or 
			datafield[@tag='880'][starts-with(subfield[@code='6'],'730')][child::*[@code='h']] or 
			datafield[@tag='880'][starts-with(subfield[@code='6'],'256')][child::*[@code='a']] or 
			datafield[@tag='880'][starts-with(subfield[@code='6'],'300')] or 
			datafield[@tag='880'][starts-with(subfield[@code='6'],'856')][child::*[code='q']]">
			<physicalDescription>
				<!-- Calls scriptCode template -->
				<xsl:for-each
					select="datafield[@tag='880'][starts-with(subfield[@code='6'],'130')][child::*[@code='h']] | 
				...
				<xsl:apply-templates
					select="datafield[@tag='880'][starts-with(subfield[@code='6'],'130')]/subfield[@code='h'] 
					...
					| datafield[@tag='880'][starts-with(subfield[@code='6'],'256')]/subfield[@code='a']"
					mode="physDesc"/>
				<xsl:apply-templates
					select="datafield[@tag='880'][starts-with(subfield[@code='6'],'856')]/child::*[code='q']"
					mode="physDesc"/>
				<xsl:apply-templates
					select="datafield[@tag='880'][starts-with(subfield[@code='6'],'300')]"
					mode="physDesc"/>
			</physicalDescription>
		</xsl:if>
	</xsl:template>
	...
	<!-- tmee 2.16
	<xsl:template match="datafield[@tag='534'] | datafield[@tag='880'][starts-with(subfield[@code='6'],'534')]" mode="note">
	...
	<xsl:template match="datafield[@tag='490'][@ind1='0']" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		<relatedItem type="series">
			<xsl:for-each
				select=". | ../datafield[@tag='880'][starts-with(subfield[@code='6'],'490')][matches(substring(subfield[@code='6'],5,2),$s6)]">
				<titleInfo>
					<!-- Template checks for altRepGroup - 880 $6 -->
					<xsl:call-template name="xxx880"/>
					<title>
	...
	<xsl:template match="datafield[@tag='440']" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		<relatedItem type="series">
			<xsl:for-each
				select=". | ../datafield[@tag='880'][starts-with(subfield[@code='6'],'440')][matches(substring(subfield[@code='6'],5,2),$s6)]">
				<titleInfo>
					<!-- Template checks for altRepGroup - 880 $6 -->
					<xsl:call-template name="xxx880"/>
					<title>
	...
	<xsl:template match="datafield[@tag='510']" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		<relatedItem type="isReferencedBy">
			<xsl:for-each
				select=". | ../datafield[@tag='880'][starts-with(subfield[@code='6'],'510')][matches(substring(subfield[@code='6'],5,2),$s6)]">
				<xsl:for-each select="subfield[@code='a']">
					<titleInfo>
						<!-- Template checks for altRepGroup - 880 $6 -->
						<xsl:call-template name="xxx880"/>
	...
	<xsl:template match="datafield[@tag='534']" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		<relatedItem type="original">
			<xsl:for-each
				select=". | ../datafield[@tag='880'][starts-with(subfield[@code='6'],'534')][matches(substring(subfield[@code='6'],5,2),$s6)]">
				<!-- call title template -->
				<xsl:apply-templates select="subfield[@code='t']" mode="relatedItem"/>
				<!-- call name template -->
	...
	<xsl:template match="datafield[@tag='700'][subfield[@code='t']]" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		<relatedItem>
			<xsl:if test="@ind2='2'">
			...
			<xsl:for-each
				select=". | ../datafield[@tag='880'][matches(substring(subfield[@code='6'],5,2),$s6)][subfield[@code='t']]">
				<titleInfo>
	...
	<xsl:template match="datafield[@tag='710'][subfield[@code='t']]" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		<relatedItem>
			<xsl:if test="@ind2='2'">
				<xsl:attribute name="type">constituent</xsl:attribute>
	...
	<xsl:template match="datafield[@tag='711'][subfield[@code='t']]" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		<relatedItem>
			<xsl:if test="@ind2='2'">
				<xsl:attribute name="type">constituent</xsl:attribute>
	...
	<xsl:template match="datafield[@tag='730'][@ind2='2']" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		<relatedItem>
			<xsl:if test="@ind2='2'">
				<xsl:attribute name="type">constituent</xsl:attribute>
			...
			<xsl:for-each
				select=". | ../datafield[@tag='880'][starts-with(subfield[@code='6'],'730')][matches(substring(subfield[@code='6'],5,2),$s6)]">
				<titleInfo>
					<xsl:call-template name="xxx880"/>
					<title>
						<xsl:value-of
	...
	<xsl:template match="datafield[@tag='740'][@ind2='2']" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		<relatedItem>
			<xsl:if test="@ind2='2'">
				<xsl:attribute name="type">constituent</xsl:attribute>
	...
	<xsl:template
		match="datafield[@tag='760'] | datafield[@tag='765'] | 
		datafield[@tag='767'] | datafield[@tag='762'] | 
		datafield[@tag='770'] | datafield[@tag='774'] | datafield[@tag='775'] |
		datafield[@tag='772'] | datafield[@tag='773'] |
		datafield[@tag='776'] | datafield[@tag='780'] |
		...
		<relatedItem>
			...
			<xsl:for-each
				select=". | ../datafield[@tag='880'][matches(substring(subfield[@code='6'],5,2),$s6)]">
				<!-- title -->
	...
	<xsl:template match="datafield[@tag='800']" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		<relatedItem type="series">
			<xsl:for-each
				select=". | ../datafield[@tag='880'][matches(substring(subfield[@code='6'],5,2),$s6)]">
	...
	<xsl:template match="datafield[@tag='810']" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		<relatedItem type="series">
			<xsl:for-each
				select=". | ../datafield[@tag='880'][matches(substring(subfield[@code='6'],5,2),$s6)]">
	...
	<xsl:template match="datafield[@tag='811']" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		<relatedItem type="series">
			<xsl:for-each
				select=". | ../datafield[@tag='880'][matches(substring(subfield[@code='6'],5,2),$s6)]">
	...
	<xsl:template match="datafield[@tag='830']" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		<relatedItem type="series">
			<xsl:for-each
				select=". | ../datafield[@tag='880'][matches(substring(subfield[@code='6'],5,2),$s6)]">
	...
	<xsl:template match="datafield[@tag='856'][@ind2='2']" mode="relatedItem">
		<xsl:variable name="s6" select="substring(normalize-space(subfield[@code='6']), 5, 2)"/>
		<relatedItem>
			<xsl:for-each
				select=". | ../datafield[@tag='880'][matches(substring(subfield[@code='6'],5,2),$s6)]">
	...
	<xsl:template match="subfield[@code='t']" mode="relatedItem">
		<titleInfo>
			<xsl:call-template name="xxs880"/>
			<title>
				<xsl:value-of select="local:stripPunctuation(.)"/>
			...
			<!-- call part numbers -->
			<xsl:apply-templates select="following-sibling::subfield[@code='n']"
				mode="relatedItem"/>
			<xsl:apply-templates select="../subfield[@code='p']" mode="relatedItem"/>
	...
	<xsl:template match="subfield[@code='n']" mode="relatedItem">
		<xsl:choose>
			<xsl:when
				test="parent::datafield[@tag='710' or @tag='810' or @tag='711' or @tag='811']">
				<xsl:if test="preceding-sibling::subfield[@code='t']">
					<partNumber>
						<xsl:value-of select="local:stripPunctuation(.)"/>
					</partNumber>
				</xsl:if>
	...
	<xsl:template match="subfield[@code='p']" mode="relatedItem">
		...
		<xsl:if test="parent::datafield[@tag='773' or @tag='786']">
			<partName>
				<xsl:value-of select="local:stripPunctuation(.)"/>
			</partName>
		</xsl:if>
	...
	<xsl:template name="xxx7xxt">
		...
		<xsl:if test="child::subfield[@code='t'] and child::subfield[@code='a']">
			<xsl:call-template name="nameTitleGroup"/>
		</xsl:if>
	</xsl:template>
