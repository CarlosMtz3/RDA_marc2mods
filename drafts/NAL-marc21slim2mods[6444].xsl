<xsl:stylesheet xmlns="http://www.loc.gov/mods/v3" xmlns:marc="http://www.loc.gov/MARC21/slim"
	...
	MARC21slim2MODS3-4 (Revision 1.99) 20220416
...
Revision 1.02 - Added Log Comment  2003/03/24 19:37:42  ckeith
	...
	<xsl:template match="*">
		<xsl:element name="marc:{name()}" namespace="http://www.loc.gov/mods/v3">
	...
	<xsl:template match="/">
			...
			<!--<modsCollection xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
				...
				<xsl:result-document method="xml" encoding="UTF-8" version="1.0" href="{replace(base-uri(), '(.*/)(.*)(\.xml|\.json)','')}">
...
-->
		...
		<!--Revision 1.96 - added LC subject authority agricola from 072 -->
		...
		<!-- Revision 1.96 - LC classification from 070 --> | identifier from 001, and notes from 910, 930, 945, 946, 974 LC 2014/04/23
		...
		<!-- Revision 1.96 - identifier from 024 -->  and notes from 910, 930, 945, 946, 974 LC 2014/04/23
		...
		<!-- Revision 1,96 - LC identifier from 001 -->
		...
		<recordInfo>
			...
			<!--<xsl:for-each select="leader[substring($leader,19,1)='i']">
			...
			<!-- Revision 1.96 - LC record identifier -->
